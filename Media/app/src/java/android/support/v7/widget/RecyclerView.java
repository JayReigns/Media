...
public class RecyclerView extends ViewGroup {
    ...
    public RecyclerView(Context context, AttributeSet attrs, int defStyle) {
        ...
        setWillNotDraw(this.getOverScrollMode() == View.OVER_SCROLL_NEVER);
    }
    ...
    void postAdapterUpdate(UpdateOp op) {
        ...
        if (mPendingUpdates.size() == 1) {
            if (mPostUpdatesOnAnimation && mHasFixedSize && mIsAttached) {
                this.postOnAnimation(mUpdateChildViewsRunnable);
            } else {
    ...
    public static abstract class LayoutManager {
         ...
         *
         * @return {@link android.support.v4.view.View#LAYOUT_DIRECTION_RTL} if the layout
         * direction is RTL or returns
         * {@link android.support.v4.view.View#LAYOUT_DIRECTION_LTR} if the layout direction
         * is not RTL.
         */
        ...
        public void detachViewAt(int index) {
            if (DISPATCH_TEMP_DETACH) {
                mRecyclerView.getChildAt(index).dispatchStartTemporaryDetach();
            }
